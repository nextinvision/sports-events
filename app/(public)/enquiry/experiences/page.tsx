...
import ExperienceEnquiryForm from "@/components/enquiry/ExperienceEnquiryForm"

export default function ExperiencesEnquiryPage() {
    return (
                ...
                <div className="container mx-auto px-6 md:px-24">
                    <AnimatedContent distance={100} direction="vertical" animateOpacity duration={0.8}>
                        <h2 className="text-2xl md:text-4xl font-normal mb-12 text-white flex items-center gap-6">
                            Paris Saint‑Germain vs. Real Madrid, March 2026
