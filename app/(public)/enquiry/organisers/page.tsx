...
import EventOrganiserEnquiryForm from "@/components/enquiry/EventOrganiserEnquiryForm"

export default function OrganiserEnquiryPage() {
    return (
                ...
                <div className="container mx-auto px-6 md:px-24 relative z-30 pt-20">
                    <AnimatedContent distance={150} direction="vertical" animateOpacity duration={0.8}>
                        <h1 className="text-4xl md:text-6xl font-normal max-w-4xl tracking-tight leading-tight mb-6">
                            The event you envision. <br />
                            The execution we deliver.
                        </h1>
                        <p className="text-xl md:text-2xl text-neutral-300 font-normal max-w-2xl leading-relaxed">
                            You build the vision. We handle the logistics—permits, participants, partnerships, moments that matter. Smooth, scalable, transparent.
                        </p>
                    </AnimatedContent>
                </div>
            </section>
